...
<qgis hasScaleBasedVisibilityFlag="0" styleCategories="LayerConfiguration|Symbology|Rendering|CustomProperties" simplifyDrawingHints="1" simplifyAlgorithm="0" readOnly="0" version="3.22.7-Białowieża" simplifyMaxScale="1" minScale="0" simplifyLocal="1" maxScale="0" symbologyReferenceScale="-1" simplifyDrawingTol="1">
  <flags>
      ...
      <symbol clip_to_extent="1" force_rhr="0" alpha="1" name="0" type="fill">
        ...
        <layer class="SimpleFill" enabled="1" pass="0" locked="0">
          <Option type="Map">
            ...
            <Option value="240,239,239,255" name="color" type="QString"/>
          ...
          <prop v="240,239,239,255" k="color"/>
